...
import { register, login, updateUser, deleteUser, getMe, getPublicPortfolio, uploadAvatar, deleteAvatar, googleAuth, forgotPassword, resetPassword } from "../controllers/UserController.js";
...
authRoute.post("/google-auth", asyncHandler(googleAuth));
authRoute.post("/forgot-password", asyncHandler(forgotPassword));
authRoute.put("/reset-password/:token", asyncHandler(resetPassword));
